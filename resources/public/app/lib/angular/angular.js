 ...
 * 
 * <pre>
 * var ology = angular.module('ology', []);
 * ology.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://ology.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://ology.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('ology', []).config(function($sceDelegateProvider) {
 ...
 *        'http://ology.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="ologyController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("ologyController", function ologyController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('ologyWithSceDisabledology', []).config(function($sceProvider) {
